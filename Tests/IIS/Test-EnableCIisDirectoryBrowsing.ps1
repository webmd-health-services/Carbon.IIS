...
{
    Enable-CIisDirectoryBrowsing -SiteName $SiteName
    Assert-DirectoryBrowsingEnabled
}

function Test-ShouldTurnOnDirectoryBrowsingUnderVirtualDirectory
{
    Install-CIisVirtualDirectory -SiteName $SiteName -Name $VDirName -Path $PSScriptRoot
...
function Assert-DirectoryBrowsingEnabled
{
    ...
    $section = Get-CIisConfigurationSection -SiteName $SiteName -SectionPath 'system.webServer/directoryBrowse' @PSBoundParameters

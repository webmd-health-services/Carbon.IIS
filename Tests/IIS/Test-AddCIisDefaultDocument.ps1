...
function Start-Test
{
    ...
    Install-CIisWebsite -Name $siteName -Path $TestDir -Bindings "http://*:$sitePort" -AppPoolName $siteName
...
{
    Add-CIISDefaultDocument -Site $SiteName -FileName 'NewWebsite.html'

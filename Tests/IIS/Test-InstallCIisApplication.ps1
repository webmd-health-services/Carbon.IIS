...
{
    $result = Install-CIISApplication -SiteName $SiteName -Name $AppName -Path $Path -AppPoolName $AppPoolName -PassThru
    Assert-NoError
...
{
    $result = Install-CIISApplication -SiteName $SiteName -Name $AppName -Path $Path 
    Assert-NoError
    Assert-Null $result
    $result = Install-CIISApplication -SiteName $SiteName -Name $AppName -Path $env:TEMP
    Assert-NoError
    Assert-Null $result
}
...
function Test-ShouldCreateApplication
{
    ...
    $app = Get-CIisApplication -SiteName $SiteName -VirtualPath $AppName
    Assert-NotNull $app
...
{
    Invoke-InstallApplication -Path "$TestDir\..\..\Tests\IIS"
    $physicalPath = Get-CIisApplication -SiteName $SiteName -Name $AppName | 
...
function Test-ShouldChangePathOfExistingApplication
{
    ...
    $app = Get-CIisApplication -SiteName $SiteName -Name $AppName
    Assert-NotNull $app
...
function Test-ShouldUpdatePath
{
    ...
    Invoke-InstallApplication
    Assert-ApplicationRunning
    $result = Install-CIisApplication -SiteName $SiteName -VirtualPath $AppName -PhysicalPath $TestDir -AppPoolName $AppPoolName
    Assert-Null $result
}

function Test-ShouldUpdateApplicationPool
{
    $result = Install-CIISApplication -SiteName $SiteName -Name $AppName -Path $TestDir -PassThru
    Assert-NoError
    Assert-NotNull $result
    Assert-Equal 'DefaultAppPool' $result.ApplicationPoolName
    Assert-ApplicationRunning

    $result = Install-CIisApplication -SiteName $SiteName -Name $AppName -PhysicalPath $TestDir -AppPoolName $AppPoolName -PassThru
    Assert-NoError
    Assert-NotNull $result
    ...
    $result = Install-CIisApplication -SiteName $SiteName -Name $AppName -PhysicalPath $TestDir -PassThru
    Assert-NoError
    Assert-NotNull $result
    Assert-Equal $AppPoolName $result.ApplicationPoolName
}

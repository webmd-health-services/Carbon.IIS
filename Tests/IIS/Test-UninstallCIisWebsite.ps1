...
{
    if( Test-CIisWebsite -Name $SiteName )
    {
...
{
    Install-CIisWebsite -Name $SiteName -Path $TestDir
...
{
    Assert-False (Test-CIisWebsite -Name $Name) "Website $Name exists!"
}

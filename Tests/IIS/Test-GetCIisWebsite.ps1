...
$appPoolName = 'Carbon-Get-CIisWebsite'
$siteName = 'Carbon-Get-CIisWebsite'
...
function Start-Test
{
    ...
    Install-CIisWebsite -Name $siteName -Bindings $bindings -Path $TestDir -AppPoolName $appPoolName
}

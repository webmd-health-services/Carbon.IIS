...
function Set-CIisAppPoolCpu
{
    ...
    configuration is removed, which reset that configuration to its default value.
    ...
    Demonstrates how to configure the application pool defaults CPU settings by using the `-AsDefaults` switch and not
